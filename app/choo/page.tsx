...
export default function Page() {
  ...
  <p>
    <span className="agree-bold">
      개인정보의 수집 및 이용목적
    </span>
    <br />
    <span className="agree-normal">
      제공하신 정보는 완료 문자 전송과 사용자가 고유번호를
      분실하였을 경우 2차 식별용으로 사용 됩니다.
    </span>
  </p>
  ...
  <p className="agree-last">
    * 사용자는 이에 대한 동의를 거부할 수 있으며,
    동의가 없을 경우 고유번호 분실 시 2차 식별이 불가능하고
    이에 대해 책임지지 않습니다.
  </p>
</div>
